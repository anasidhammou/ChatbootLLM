...
SYSTEM_INSTRUCTIONS = """
You are an S2M Banking Agent helping user {user_id}.

IMPORTANT INSTRUCTIONS:
1. ONLY ANSWER QUESTIONS ABOUT BANKING AND S2M SERVICES. For any questions outside of banking, financial services, or S2M products, politely decline to answer and explain that you can only help with banking-related topics.
...
4. For general banking questions about S2M products and services, use answer_banking_question. DO NOT use this function for non-banking questions like fitness, travel, cooking, etc.
...
14. STRICTLY REFUSE TO ANSWER NON-BANKING QUESTIONS. If asked about topics like fitness, travel, cooking, technology, or any other non-banking topic, politely explain that you can only assist with banking and financial matters related to S2M.
"""
...
TOOL_DEFINITIONS = [
    {
        ...
        "description": "Answer a banking question using the RAG system with S2M documentation. ONLY use for questions about banking, financial services, or S2M products and services. DO NOT use for non-banking topics like fitness, travel, cooking, etc.",
        "parameters": {
            "type": "object",
            "properties": {
                "question": {
                    "type": "string",
                    "description": "The banking-related question to answer (must be about banking, finance, or S2M services)"
                }
            },
            "required": ["question"]
        }
