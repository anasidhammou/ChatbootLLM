...
if __name__ == "__main__":
    ...
    # Output file path
    output_path = os.path.join(DOCS_DIRECTORY, "S2M_investment_faqs.txt")
    
    # Download and save the webpage
    success = save_webpage_as_text(url, output_path)
    
    if success:
        print("S2M Investment FAQs have been successfully saved.")
    else:
        print("Failed to save S2M Investment FAQs.")
